...
//open class SchemeHostHttpExchange<ParsedResponse: Sendable>: HttpExchange<ParsedResponse> {
//    
...
//}
//
//open class RequestDataHttpExchange<RequestData: Sendable, ParsedResponse: Sendable>: HttpExchange<ParsedResponse> {
//    
